...
namespace frontend.Migrations
{
    ...
    [Migration("20251128120903_AddAnalytics")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("frontend.Entities.AIChatHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frontend.Entities.AISession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("frontend.Entities.ConversationAnalytics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HandoffToHuman")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("ConversationAnalytics");
                });
            ...
            modelBuilder.Entity("frontend.Entities.AIChatHistory", b =>
                {
                    b.HasOne("frontend.Entities.AISession", "AISession")
            ...
            modelBuilder.Entity("frontend.Entities.AISession", b =>
                {
                    b.HasOne("frontend.Data.ApplicationUser", "User")
                        .WithMany("AISessions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
